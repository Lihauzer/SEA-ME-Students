...
int Phone_book::check_phone(string str)
{
...
int Phone_book::check_index(string str, int j)
{
    if (str == "" || str == "0")
...
void Phone_book::add_bookmark(int i)
{
...
int Phone_book::ft_satoi(string input)
{
    int tmp_index = 0;
